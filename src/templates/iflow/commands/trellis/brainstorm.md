...
- If Intent is missing, prefer read-only research before asking for more detail whenever repo/docs/specs likely contain the answer.
...
- Example styles:
  - "先把 Intent 补齐。Dazz 先把这张纸立住，再带你往下走。"
